// Polls the npm registry for new @anthropic-ai/claude-code versions.
// Emits one event per unseen version. Body is left null — the claude_code_changelog
// source fills in changelog text by version.
...
export async function runNpmClaudeCode(): Promise<RunResult> {
